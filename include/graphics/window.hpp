...
#define IS_KEY(key, state) (Graphics::Window::getActive() != nullptr and Graphics::Window::getActive()->isKey(key, state))
#define IS_MOUSE(button, state) (Graphics::Window::getActive() != nullptr and Graphics::Window::getActive()->isMouse(button, state))
#define RESET_MOUSE() (Graphics::Window::getActive() != nullptr ? Graphics::Window::getActive()->resetMouse() : void())
#define GET_RELATIVE_MOUSE(x, y) (Graphics::Window::getActive() != nullptr ? Graphics::Window::getActive()->getRelativeMouse(x, y) : void())
#define GET_ABSOLUTE_MOUSE(x, y) (Graphics::Window::getActive() != nullptr ? Graphics::Window::getActive()->getAbsoluteMouse(x, y) : void())
