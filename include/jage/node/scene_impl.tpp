...
template<class T, class... Args>
T *jage::node::Scene::addVolatileChild(JAGE_SCENE_ACTOR_ARGS, Args&&... args) {
    static_assert(std::is_base_of<NodeType, T>::value, "Cannot add a non-Hierarchy child");
